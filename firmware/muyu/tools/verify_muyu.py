...
assert 0x10000 < len(data) <= 0x356000, 'Merged image must end before protected cardid'
...
assert 'CONFIG_BT_ENABLED=y' not in config
info = {
    'application': 'muyu', 'version': '0.1.0',
    ...
    'protected_cardid_offset': '0x356000', 'device_tests': 'NOT RUN'
}
