...
状态：后续接入规划，尚未接通语音。2026-09-13 更新：**独立“小智”应用与宠物聊天模式共用一份语音服务、同一云端智能体的人格、声音与记忆配置**。宠物成为该角色的 Avatar；IDA 保留后续独立语音入口。跨入口记忆需要真实服务验证，共用声音不代表共享 IDA 权限。当前证据和实施计划见[小智融合研究与实施方案](xiaozhi-research.zh_CN.md)。
